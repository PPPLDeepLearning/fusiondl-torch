...
t_warn = CategoricalHyperparam(["data", "T_warning"], [30, 50, 20.024, 8, 10.024])
...
if shallow:
    ...
    batch_size = CategoricalHyperparam(
        ["training", "batch_size"], [8, 8, 16, 16, 32, 32, 32, 64, 128]
    )
    ...
    cell_order = CategoricalHyperparam(
        ["model", "cell_order"], [1, 1, 1, 1, 2, 2, 3, 4]
    )
    ...
    dense_size = CategoricalHyperparam(
        ["model", "dense_size"], [8, 16, 20, 32, 64, 128, 200, 160]
    )
