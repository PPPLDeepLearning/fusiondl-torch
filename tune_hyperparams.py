...
t_warn = CategoricalHyperparam(['data', 'T_warning'], [30,50,20.024,8,5,
                                                       10.024])
...
if shallow:
    ...
    tunables = [target,t_warn,conv_filters,model_type,conv_layers,lr, lr_decay_factor,lr_decay_patience, fac, batch_size, equalize_classes,
